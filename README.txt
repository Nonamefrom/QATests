...
# Сборка докер контейнера в корневой папке проекта после вызова командной строки(из адресной)
# docker build -t qa_cp_tests .
# Запуск контейнера в той же ком. строке
# docker run -d qa_cp_tests
# Запуск тестов из контейнера
# docker exec -it "имя_контейнера" pytest